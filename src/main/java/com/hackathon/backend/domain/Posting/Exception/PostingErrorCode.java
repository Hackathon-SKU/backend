package com.hackathon.backend.domain.Posting.Exception;
...
public enum PostingErrorCode implements BaseErrorCode {
    ...
    EMAIL_ALREADY_EXIST("AUTH_401_007", "해당 이메일이 이미 존재합니다.", HttpStatus.UNAUTHORIZED),
    ...
    MALFORMED_JWT("JWT_401_008", "잘못된 구조의 JWT입니다.", HttpStatus.UNAUTHORIZED),
    WRONG_STYLE_INPUT("JWT_401_009", "잘못된 입력 인자가 들어왔습니다.", HttpStatus.UNAUTHORIZED)
    ;
